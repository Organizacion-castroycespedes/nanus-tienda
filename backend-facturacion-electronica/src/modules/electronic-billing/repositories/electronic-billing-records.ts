...
import type {
  ElectronicBillingEnvironment as DomainElectronicBillingEnvironment,
  ElectronicBillingProviderCapabilities,
  ElectronicDocumentStatus as DomainElectronicDocumentStatus,
  ElectronicDocumentType as DomainElectronicDocumentType,
  ElectronicDocumentSourceType as DomainElectronicDocumentSourceType,
  ElectronicDocumentEventType as DomainElectronicDocumentEventType,
  ElectronicDocumentDeliveryType as DomainElectronicDocumentDeliveryType,
  ElectronicDocumentAttachmentType as DomainElectronicDocumentAttachmentType,
  ElectronicDocumentReferenceType as DomainElectronicDocumentReferenceType,
} from "../domain/electronic-billing.types";

export type ElectronicBillingEnvironment = DomainElectronicBillingEnvironment;
export type ElectronicDocumentStatus = DomainElectronicDocumentStatus;
export type ElectronicDocumentType = DomainElectronicDocumentType;
export type ElectronicDocumentSourceType = DomainElectronicDocumentSourceType;
export type ElectronicDocumentEventType = DomainElectronicDocumentEventType;
export type ElectronicDocumentDeliveryType = DomainElectronicDocumentDeliveryType;
export type ElectronicDocumentAttachmentType = DomainElectronicDocumentAttachmentType;
export type ElectronicDocumentReferenceType = DomainElectronicDocumentReferenceType;
export type ElectronicBillingInboxEventStatus = "RECEIVED" | "PROCESSED" | "FAILED";
...
export type ElectronicBillingProviderRecord = QueryResultRow & {
  ...
  active: boolean;
  capabilities: ElectronicBillingProviderCapabilities | Record<string, unknown>[] | string[] | null;
...
export type ElectronicBillingInboxEventRecord = QueryResultRow & {
  id: string;
  event_id: string;
  event_type: string;
...
export type NewElectronicBillingInboxEventInput = {
  id: string;
  eventId: string;
  eventType: string;
