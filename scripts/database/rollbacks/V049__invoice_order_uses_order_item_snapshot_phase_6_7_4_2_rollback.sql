-- Rollback Fase 6.7.4.2: restaura inventory_invoice_order legacy.
-- Vuelve a usar order_items.price y products/taxes actuales para calcular
-- price_without_tax, tax_total, subtotal y sale_item_taxes.
