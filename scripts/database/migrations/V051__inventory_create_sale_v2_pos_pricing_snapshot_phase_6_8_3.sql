...
-- Lee payload enriquecido de SaleService/PricingService para ventas POS directas.
-- Mantiene stock, FEFO, lotes, pagos y fallback legacy sin cambios funcionales.
