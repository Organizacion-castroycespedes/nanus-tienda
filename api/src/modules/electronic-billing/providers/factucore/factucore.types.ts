import type { ElectronicBillingProviderContext } from "../../contracts/electronic-billing-commands";
import type { ElectronicDocumentStatus } from "../../types/electronic-billing-records";
