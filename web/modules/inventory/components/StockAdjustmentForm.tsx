  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:bg-slate-800 dark:border-slate-700">
      <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">Stock</p>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Ajustar stock</h2>
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
            Producto: <span className="font-medium text-slate-900 dark:text-white">{product.name}</span>
          </p>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="space-y-1 md:col-span-3">
            ...
            {selectedBranchName && values.branchId ? (
              <p className="text-xs text-slate-500 dark:text-slate-400">Movimiento para: {selectedBranchName}</p>
            ) : null}
          ...
          <section className="rounded-xl border border-blue-200 bg-blue-50/50 p-4">
            ...
            {values.type === "IN" ? (
              ...
              <div className="grid gap-4 md:grid-cols-[1fr_180px]">
                ...
                <div className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200">
                  <p className="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">Disponible</p>
