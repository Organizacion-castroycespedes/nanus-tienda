# catalog-action-focus-ux Specification

## Purpose
TBD - created by archiving change mejorar-focus-acciones-clientes-unidades-proveedores. Update Purpose after archive.
## Requirements
