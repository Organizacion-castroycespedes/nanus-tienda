...
- [ ] P7 Ejecutar packaging y pruebas automatizadas; despues QA fisico del fixture XP-58/XP-80. Evidencia: 7.2Q PASS para impresion fisica XP-58 y cajon VIA_PRINTER; 7.2U PASS para certificacion, impresion/corte y cajon VIA_PRINTER de XP-80; scanner HID real en vista principal del POS PASS en QA Electron empaquetado; fullscreen Electron 7.2X PASS/CLOSED; handoff Electron-Agent PHYSICAL QA FAIL por bypass WebSocket/configuracion HTTPS en `contracts.ts`; quedan abiertos los gates listados en `qa-evidence.md`.
