...
3. Backend API y reglas de negocio.
4. Frontend modulo Domicilios.
5. Integracion con pedidos/facturacion/caja.
6. Reporteria y auditoria.
7. QA integral y hardening.
