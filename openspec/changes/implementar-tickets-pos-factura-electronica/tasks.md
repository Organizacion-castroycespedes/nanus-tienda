...
- [x] Usar permisos server-granted para mostrar `OPERATIONS` y `OPERATIONS_SALES` a roles POS.
- [x] Cubrir filtrado de menú con regresión Web.

## Impresión

- [x] Reusar `Peripheral Agent` y crear tipo `ELECTRONIC_INVOICE`.
